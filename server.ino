...
callback_function gHighResolution;
callback_function gLowResolution;
callbakc_function Time;

void resolution_High(void);
void resolution_Low(void);
void Timer(void);
...
void setup() 
{
  ...
  gHighResolution = resolution_High;
  gLowResolution  = resolution_Low;
  Time = Timer;
